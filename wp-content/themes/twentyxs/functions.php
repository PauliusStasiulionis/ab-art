...
#access ul ul :hover > a,#breadcrumbs a,#enjoy-description a,#article_metabox_comments a,.wp-pagenavi a{
	color:<?php echo stripslashes(TwentyXS_option('xs_linkcolour_hover_select')); ?>;
}
.entry-content a:hover,#access .menu li:hover,.wp-pagenavi a:hover,.wp-pagenavi span.current {
...
#access .menu-header ul,div.menu ul,.wp-pagenavi{
	text-align:<?php echo stripslashes(TwentyXS_option('xs_navi_orientation')); ?>;
		...
		<?php } endif; ?>
		<?php if (TwentyXS_option('xs_expand_logo')) : { ?>
