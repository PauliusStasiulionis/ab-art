<?php /* Smarty version 2.6.26, created on 2012-12-15 08:54:40
         compiled from /var/www/vhosts/ab-art.lt/httpdocs/piwik/plugins/PrivacyManager/templates/privacySettings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', '/var/www/vhosts/ab-art.lt/httpdocs/piwik/plugins/PrivacyManager/templates/privacySettings.tpl', 7, false),array('modifier', 'inlineHelp', '/var/www/vhosts/ab-art.lt/httpdocs/piwik/plugins/PrivacyManager/templates/privacySettings.tpl', 30, false),array('modifier', 'escape', '/var/www/vhosts/ab-art.lt/httpdocs/piwik/plugins/PrivacyManager/templates/privacySettings.tpl', 245, false),array('function', 'url', '/var/www/vhosts/ab-art.lt/httpdocs/piwik/plugins/PrivacyManager/templates/privacySettings.tpl', 13, false),)), $this); ?>
...
<br/>
			...
			<?php ob_start(); ?>
				...
				<br/><br/><?php echo ((is_array($_tmp='PrivacyManager_CannotLockSoDeleteLogActions')) ? $this->_run_mod_handler('translate', true, $_tmp, $this->_tpl_vars['dbUser']) : smarty_modifier_translate($_tmp, $this->_tpl_vars['dbUser'])); ?>
...
" style="width:30px;"
		...
		<tr id='deleteReportsSettingEnabled'>
			...
			<td width="500">
				<label><input type="radio" name="deleteReportsEnable" value="1" <?php if ($this->_tpl_vars['deleteData']['config']['delete_reports_enable'] == '1'): ?>checked="true"<?php endif; ?>/> <?php echo ((is_array($_tmp='General_Yes')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</label>
				<label><input type="radio" name="deleteReportsEnable" value="0" <?php if ($this->_tpl_vars['deleteData']['config']['delete_reports_enable'] == '0'): ?>checked="true"<?php endif; ?> style="margin-left:20px;"/> <?php echo ((is_array($_tmp='General_No')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...
" style="width:30px;"
				...
				<label><input type="checkbox" name="deleteReportsKeepBasic" value="1" <?php if ($this->_tpl_vars['deleteData']['config']['delete_reports_keep_basic_metrics']): ?>checked="true"<?php endif; ?>><?php echo ((is_array($_tmp='PrivacyManager_KeepBasicMetrics')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
<span class="form-description"><?php echo ((is_array($_tmp='General_Recommended')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</span></input>
				</label><br/><br/>
...
<br/>
				<label><input type="checkbox" name="deleteReportsKeepDay" value="1" <?php if ($this->_tpl_vars['deleteData']['config']['delete_reports_keep_day_reports']): ?>checked="true"<?php endif; ?>><?php echo ((is_array($_tmp='General_DailyReports')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</input></label><br/>
				<label><input type="checkbox" name="deleteReportsKeepWeek" value="1" <?php if ($this->_tpl_vars['deleteData']['config']['delete_reports_keep_week_reports']): ?>checked="true"<?php endif; ?>><?php echo ((is_array($_tmp='General_WeeklyReports')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</input></label><br/>
				<label><input type="checkbox" name="deleteReportsKeepMonth" value="1" <?php if ($this->_tpl_vars['deleteData']['config']['delete_reports_keep_month_reports']): ?>checked="true"<?php endif; ?>><?php echo ((is_array($_tmp='General_MonthlyReports')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
<span class="form-description"><?php echo ((is_array($_tmp='General_Recommended')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</span></input></label><br/>
				<label><input type="checkbox" name="deleteReportsKeepYear" value="1" <?php if ($this->_tpl_vars['deleteData']['config']['delete_reports_keep_year_reports']): ?>checked="true"<?php endif; ?>><?php echo ((is_array($_tmp='General_YearlyReports')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
<span class="form-description"><?php echo ((is_array($_tmp='General_Recommended')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</span></input></label><br/>
				<label><input type="checkbox" name="deleteReportsKeepRange" value="1" <?php if ($this->_tpl_vars['deleteData']['config']['delete_reports_keep_range_reports']): ?>checked="true"<?php endif; ?>><?php echo ((is_array($_tmp='General_RangeReports')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</input></label><br/><br/>
				<label><input type="checkbox" name="deleteReportsKeepSegments" value="1" <?php if ($this->_tpl_vars['deleteData']['config']['delete_reports_keep_segment_reports']): ?>checked="true"<?php endif; ?>><?php echo ((is_array($_tmp='PrivacyManager_KeepReportSegments')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</input></label><br/>
			</td>
			<td width="200">
		...
		<tr id="deleteDataEstimateSect" <?php if ($this->_tpl_vars['deleteData']['config']['delete_reports_enable'] == '0' && $this->_tpl_vars['deleteData']['config']['delete_logs_enable'] == '0'): ?>style="display:none;"<?php endif; ?>>
...
<br/></td>
			<td width="500">
				<?php echo ((is_array($_tmp='PrivacyManager_DeleteDataInterval')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
...
:</strong>
					...
					<br/><br/><em><a id="purgeDataNowLink" href="#"><?php echo ((is_array($_tmp='PrivacyManager_PurgeNow')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a></em>
					<span class='loadingPiwik' style='display:none'><img src='./themes/default/images/loading-blue.gif' /> <?php echo ((is_array($_tmp='PrivacyManager_PurgingData')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</span>
...
</b> <br/><?php echo ((is_array($_tmp='PrivacyManager_DoNotTrack_EnabledMoreInfo')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
