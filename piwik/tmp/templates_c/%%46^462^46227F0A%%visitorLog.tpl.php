...
<?php endif; ?><?php if (isset ( $this->_tpl_vars['action']['timeSpentPretty'] )): ?> - <?php echo ((is_array($_tmp='General_TimeOnPage')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
