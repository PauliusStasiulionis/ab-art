...
<div id="rss_button"><div id="rss_button_child"><a href="<?php bloginfo('rss2_url'); ?>" title="Subscribe to RSS">
<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/rss_badge_subscribe.png"></a></div></div>
<?php } endif; ?>
