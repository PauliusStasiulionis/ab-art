				...
				switch ($image_column_key) {
					...
					break;
                                        case 'long_description' :
                                            ?>
                                                <td <?php echo $attributes ?>>
                                                    <textarea name="long_description[<?php echo $pid ?>]" style="width:95%; margin-top: 2px;" rows="3"><?php echo stripslashes($picture->description_long) ?></textarea>
					...
					case 'exclude' :
						?>
						<td <?php echo $attributes ?>>KuRIS ?<input name="exclude[<?php echo $pid ?>]" type="checkbox" value="1" <?php echo $exclude ?> /></td>
						<?php						
					break;
					case 'tags' :
...
class _NGG_Images_List_Table extends WP_List_Table {
	...
	function get_columns() {
        ...
        $columns['long_description'] = __('Long description', 'nggallery');
